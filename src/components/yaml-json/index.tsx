...
type IndentSize = 2 | 4;
type NumberHandling = "keep" | "string" | "number";
type NullHandling = "null" | "empty" | "omit";
type QuoteStyle = "auto" | "always" | "minimal";
type FlowStyle = "block" | "flow";
type MultiDocMode = "all" | "first";
